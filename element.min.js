!(function () {
    if (!customElements.get("flag-olympic")) {
        let t = "https://flagmeister.github.io/elements.flagmeister.min.js";
        document.head.append(
            Object.assign(document.createElement("script"), { src: t })
        );
    }
})(),
        ...
        customElements.define(
            ...
            class extends HTMLElement {
                async connectedCallback() {
                    const t = this.getAttribute("lang") || "ENG",
                        e = `https://olympics.com/OG2024/data/CIS_MedalNOCs~lang=${t}~comp=OG2024.json`,
                        a =
                            "AFG:af,ALB:al,ALG:dz,AND:ad,ANG:ao,ANT:ag,ARG:ar,ARM:am,ARU:aw,ASA:as,AUS:au,AUT:at,AZE:az,BAH:bs,BRN:bh,BAN:bd,BAR:bb,BLR:by,BEL:be,BEN:bj,BER:bm,BHU:bt,BOL:bo,BIH:ba,BOT:bw,BRA:br,IVB:vg,BRU:bn,BUL:bg,BUR:bf,BDI:bi,CPV:cv,CAM:kh,CMR:cm,CAN:ca,CAY:ky,CAF:cf,CHA:td,CHI:cl,CHN:cn,COL:co,COM:km,COD:cd,COK:ck,CRC:cr,CIV:ci,CRO:hr,CUB:cu,CYP:cy,CZE:cz,DEN:dk,DJI:dj,DMA:dm,DOM:do,ECU:ec,EGY:eg,ESA:sv,GEQ:gq,ERI:er,EST:ee,ETH:et,FIJ:fj,FIN:fi,FRA:fr,GAB:ga,GAM:gm,GEO:ge,GER:de,GHA:gh,GRE:gr,GRN:gd,GUM:gu,GUA:gt,GUI:gn,GBS:gw,GUY:gy,HAI:ht,HON:hn,HKG:hk,HUN:hu,ISL:is,IND:in,INA:id,IRI:ir,IRQ:iq,IRL:ie,ISR:il,ITA:it,JAM:jm,JPN:jp,JOR:jo,KAZ:kz,KEN:ke,PRK:kp,KOR:kr,KOS:xk,KUW:kw,KGZ:kg,LAO:la,LAT:lv,LBN:lb,LES:ls,LBR:lr,LBA:ly,LIE:li,LTU:lt,LUX:lu,MAD:mg,MAW:mw,MAS:my,MDV:mv,MLI:ml,MLT:mt,MTN:mr,MRI:mu,MEX:mx,MDA:md,MGL:mn,MNG:mn,MNE:me,MAR:ma,MOZ:mz,MYA:mm,NAM:na,NRU:nr,NEP:np,NED:nl,NZL:nz,NCA:ni,NIG:ng,NOR:no,OMA:om,PAK:pk,PLW:pw,PLE:ps,PAN:pa,PNG:pg,PAR:py,PER:pe,PHI:ph,POL:pl,POR:pt,PUR:pr,QAT:qa,ROU:ro,RUS:ru,RWA:rw,SKN:kn,LCA:lc,VIN:vc,SAM:ws,SMR:sm,STP:st,KSA:sa,SEN:sn,SRB:rs,SEY:sc,SLE:sl,SGP:sg,SVK:sk,SLO:si,SOL:sb,SOM:so,RSA:za,ESP:es,SRI:lk,SUD:sd,SUR:sr,SWZ:sz,SWE:se,SUI:ch,SYR:sy,TPE:tw,TJK:tj,TAN:tz,THA:th,TLS:tl,TOG:tg,TGA:to,TRI:tt,TUN:tn,TUR:tr,TKM:tm,UGA:ug,UKR:ua,UAE:ae,GBR:gb,USA:us,URU:uy,UZB:uz,VAN:vu,VEN:ve,VIE:vn,ISV:vi,YEM:ye,ZAM:zm,ZIM:zw"
                                .split(",")
                                .map((t) => t.split(":"))
                                .reduce((t, [e, a]) => ((t[e] = a), t), {}),
                        l = (t) =>
                            t.sort(
                                (t, e) =>
                                    e.gold - t.gold || e.silver - t.silver || e.bronze - t.bronze
                            ),
                        o = this.getAttribute("flag") || "olympic",
                        s = this.getAttribute("games") || "Paris 2024",
                        n = this.getAttribute("filter"),
                        r = this.getAttribute("total") || 10;
                    "all" == n && (n = ""),
                        "EU" == n &&
                        ((n =
                            "AUT,BEL,BUL,CRO,CYP,CZE,DEN,EST,FIN,FRA,GER,GRE,HUN,IRL,ITA,LAT,LTU,LUX,MLT,NED,POL,POR,ROU,SVK,SLO,ESP,SWE"),
                            (r = "all")),
                        "all" == r && (r = 999);
                    const i = (await (await fetch(e)).json()).medalNOC,
                        d = l(i.filter((t) => "TOT" === t.gender && "GLO" === t.sport)).map(
                            (t) => ({
                                country: {
                                    code: t.org,
                                    name: t.organisation.description,
                                    flag: a[t.org],
                                },
                                ranking: {
                                    rank: t.rank,
                    ...
                    console.log(
                        `%c ${d.length} countries won medals `,
                        "background:gold"
                    ),
                        (this.attachShadow({ mode: "open" }).innerHTML =
                            "<style>:host{--flagmeisterdetail:100}table{border-collapse:collapse;font:100% Arial;border:1px solid grey}td{padding:3px;text-align:left;border-bottom:1px solid lightgrey}.header,.rank,.flag,.medals{text-align:center;width:8%}.gold{background:gold}.silver{background:silver}.bronze{background:peru}.flag img{display:inline-block;max-width:100%;border:1px solid grey;vertical-align:top}</style><table part=table><thead part=thead><tr>" +
                            `<td colspan=3><flag-${o} detail=9999></flag-olympic></td>` +
                            `<td colspan=5 class=header part=header><slot>${s} Olympic Medal Ranking</slot></td>` +
                            "</tr></thead><tbody>" +
                            d
                                .slice(0, r)
                                .map((t, e) => {
                                    const a = t.country.code,
                                        l = t.ranking.rank;
                                    if (n && !n.includes(a)) return "";
                                    const o = t.country.name,
                                        s = this.hasAttribute("detailflags")
                                            ? "ECU,KAZ,MEX,KAZ,MGL,MDA,EGY,FIJ"
                                            : "",
                                        r = s.includes(a) ? "detail=10" : "",
                                        i = `<flag-${t.country.flag} ${r}></flag-${t.country.flag}>`,
                                        d = (e) =>
                                            `<td class="medals ${e}" part="medal medal${e}" >${t.medals[e]}</td>`;
                                    return (
                                        `<tr id=${a} title=${o}>` +
                                        `<td class=rank part=rank>${l}</td>` +
                                        `<td class=flag>${i}</td>` +
                                        `<td part=countrycode> ${a}</td>` +
                                        `<td part=countryname >${o}</td>` +
                                        ["gold", "silver", "bronze", "total"].map(d).join("") +
                                        "</tr>"
                                    );
                                })
                                .join("") +
                            "</tbody></table>"),
                        [...this.shadowRoot.querySelectorAll("[id]")].map((t) => {
                            t.onclick = () => {
                                console.log(t.id, t.title),
                                    (document.location = `https://olympics.com/en/paris-2024/medals/${t.title.toLowerCase()}`);
                            };
                        });
                }
            }
