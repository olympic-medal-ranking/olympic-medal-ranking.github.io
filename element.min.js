        ...
        customElements.define(
            ...
            class extends HTMLElement {
                async connectedCallback() {
                    ...
                    let o = this.getAttribute("flag") || "olympic",
                        s = this.getAttribute("games") || "Paris 2024",
                        r = this.getAttribute("filter"),
                        n = this.getAttribute("total") || 10;
                    "all" == r && (r = ""),
                        "EU" == r &&
                        ((r =
                ...
                `<td colspan=3><flag-${o} detail=10000></flag-olympic></td>` +
                `<td colspan=5 class=header part=header><slot>${s}</slot></td>` +
                "</tr></thead><tbody>" +
                d
                .slice(0, n)
                .map((t, e) => {
                  ...
                  const o = t.country.name,
                      s = this.hasAttribute("detailflags")
                          ...
                          : "",
                      n = `<flag-${t.country.flag} ${s.includes(a) ? "detail=10" : ""
                          }></flag-${t.country.flag}>`,
                      i = (e) =>
                  ...
                  return (
                      ...
                      ["gold", "silver", "bronze", "total"].map(i).join("") +
                      "</tr>"
                  );
              })
                                .join("") +
